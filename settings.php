...
<script src="<?php bloginfo('template_url'); ?>/assets/vendor/jquery/jquery.min.js"></script>
	...
	<div>
		...
		<p style="margin-top: 20px;">
			<a href="https://github.com/Santiago-hang/Argon-Santiago/" target="_blank" style="box-shadow: none;text-decoration: none;">
				...
				<span style="font-size: 20px;transform: translate(5px,-9px);display: inline-block;">Santiago-hang/Argon-Santiago</span>
			</a>
		</p>
		<h1 style="color: #5e72e4;"><?php _e("Argon-Santiago 主题设置", 'argon'); ?></h1>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php _e('Argon-Santiago 主题会根据这里的选项来决定是否默认使用夜间模式。', 'argon');?><br/><?php _e('用户也可以手动切换夜间模式，用户的设置将保留到标签页关闭为止。', 'argon');?></p>
						</td>
					</tr>
					<tr>
	...
	//do something...
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php _e('开启后评论支持插入表情，会在评论输入框下显示表情键盘按钮。', 'argon');?><br/><a href="https://github.com/Santiago-hang/Argon-Santiago#emotions" target="_blank"><?php _e('如何添加新的表情或修改已有表情列表？', 'argon');?></a></p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<select name="argon_hide_footer_author">
								...
								<option value="false" <?php if ($argon_hide_footer_author=='false'){echo 'selected';} ?>>Theme Argon-Santiago By Santiago</option>
								<option value="true" <?php if ($argon_hide_footer_author=='true'){echo 'selected';} ?>>Theme Argon-Santiago</option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
